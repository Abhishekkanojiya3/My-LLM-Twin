...
class SelfQueryTemplate(BasePromptTemplate):
    ...
    For example:
    QUESTION 1:
    My name is Abhishek Kanojiya and I want a post about...
    RESPONSE 1:
    Abhishek Kanojiya
...
class RerankingTemplate(BasePromptTemplate):
    ...
    Your response must contain ONLY the reranked passages, verbatim, joined by '{separator}'.
    Do not add any commentary, explanations, relevance scores, numbering, or extra text of any kind.
